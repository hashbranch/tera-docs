...
Tera is in private access while we onboard with OpenRouter. Email [tom@hashbranch.com](mailto:tom@hashbranch.com?subject=Tera%20API%20access) with a one-line description of what you're building.
