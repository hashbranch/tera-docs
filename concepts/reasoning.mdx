...
description: "How to use `<think>` traces with Qwen3.5 and other thinking models."
---
...
Thinking models in the catalog today:

- [Qwen/Qwen3.5-27B](/models/qwen3-5-27b)
...
OpenAI clients expect `content` to be the user-facing answer. Mixing `<think>...</think>` markers into `content` breaks downstream parsers. By separating the two, OpenAI SDKs work without modification and reasoning becomes an opt-in feature on the client side.
