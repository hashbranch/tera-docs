...
- **Heartbeats** — we do not currently send keep-alive comments. Configure client read timeouts above your expected longest generation (default vLLM timeouts: 120s).
