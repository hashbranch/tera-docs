---
title: "DeepSeek-V3.1"
description: "deepseek-ai/DeepSeek-V3.1 on Tera"
---

<Info>
  Model id: `deepseek-ai/DeepSeek-V3.1` — pass this as the `model` field in API requests.
</Info>
...
| **HuggingFace** | [`deepseek-ai/DeepSeek-V3.1`](https://huggingface.co/deepseek-ai/DeepSeek-V3.1) |
