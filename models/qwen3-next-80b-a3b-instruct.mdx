...
description: "Qwen/Qwen3-Next-80B-A3B-Instruct on Tera"
---

<Info>
  Model id: `Qwen/Qwen3-Next-80B-A3B-Instruct` — pass this as the `model` field in API requests.
</Info>
...
|---|---|
| **Provider** | qwen |
| **HuggingFace** | [`Qwen/Qwen3-Next-80B-A3B-Instruct`](https://huggingface.co/Qwen/Qwen3-Next-80B-A3B-Instruct) |
