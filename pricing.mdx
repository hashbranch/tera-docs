...
All prices are in USD per **million tokens**. Updated 2026-09-05.
...
| `openai/gpt-5.6-luna` | $0.20 | $1.20 | $0.02 | `managed` | 1,050,000 |
...
| `openai/gpt-5.6-terra` | $2.00 | $12.00 | $0.20 | `managed` | 1,050,000 |
