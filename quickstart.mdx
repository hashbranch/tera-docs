...
Tera is currently in private access. Email [tom@hashbranch.com](mailto:tom@hashbranch.com?subject=Tera%20API%20access) to request a key. Keys are formatted as `sk-tera-...`.
...
<CardGroup cols={2}>
  ...
  <Card title="Reasoning models" icon="brain" href="/concepts/reasoning">
    How to use `<think>` traces with Qwen3.5.
  </Card>
